import { ArrowRight, Brain, Target, Zap, LayoutDashboard, Library, Play } from "lucide-react";
      ...
      <div className="flex flex-col items-center justify-center px-6 py-24 sm:py-32 lg:px-8">
        <div className="max-w-2xl text-center">
          ...
          <div className="mt-10 flex items-center justify-center gap-x-6">
            <Link href="/test-analysis" className="rounded-xl bg-primary px-6 py-3 text-sm font-semibold text-white shadow-sm hover:bg-primary/80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary transition-all flex items-center gap-2">
              Testar Análise <ArrowRight className="h-4 w-4" />
            </Link>
            <Link href="/knowledge" className="text-sm font-semibold leading-6 text-foreground flex items-center gap-2">
              Subir Arquivos <span aria-hidden="true">→</span>
            </Link>
          </div>
        </div>

        <div className="mt-24 grid grid-cols-1 gap-8 sm:grid-cols-3 max-w-5xl px-6 pb-24">
          <FeatureCard 
